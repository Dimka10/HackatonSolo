...
from refalcamp.settings import EMAIL_HOST_USER
...
class User(AbstractBaseUser):
    ...
    def activate_with_code(self, activation_code):
        if self.activation_code != activation_code:
            raise Exception('Проверьте код и повторите снова')
        self.is_active = True
        self.save()
    ...
    def send_activation_email(self):
        ...
        send_mail('Ваш аккаунт успешно активирован ', msg, EMAIL_HOST_USER, [self.email])
